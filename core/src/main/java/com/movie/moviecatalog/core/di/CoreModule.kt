package com.movie.moviecatalog.core.di

import androidx.room.Room
import com.movie.moviecatalog.core.data.MovieRepository
import com.movie.moviecatalog.core.data.source.local.LocalDataSource
import com.movie.moviecatalog.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val pass: ByteArray = SQLiteDatabase.getBytes("moviescatalog".toCharArray())
